...
// Add an event transfering amount x at the current time. The function waits
// to ensure that the maximum rate is not violated. 
...
// The average rate of transfer over the duration interval. 
